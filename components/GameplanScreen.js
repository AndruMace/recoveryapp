...
async function generateKey() {
  ...
  let planKeys = await getPlanKeys()
  return `plan_${ranFormatted}_${planKeys.length}`
}
...
export default function GameplanScreen() {
  ...
  return (
    <View style={styles.viewStyle}>
      <Text style={styles.text}>If I relapse, what can I do to get back on track?</Text>
      <TextInput 
        style={styles.input} 
        onChangeText={setText} 
        value={text}
        placeholder='E.g. "I will reach out for support, I will..."'
        multiline={true}
      />
      <Pressable 
        style={[styles.button]}
