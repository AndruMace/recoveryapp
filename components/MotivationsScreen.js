...
async function generateKey() {
  ...
  let motiKeys = await getMotiKeys()
  return `moti_${ranFormatted}_${motiKeys.length}`
}
...
export default function MotivationsScreen() {
  ...
  return (
    <View style={styles.viewStyle}>
      <Text style={styles.text}>What motivates me to do better?</Text>
      <TextInput 
        style={styles.input} 
        onChangeText={setText} 
        value={text}
        placeholder='E.g. "My career goals, my family, etc..."'
        multiline={true}
      />
      <Pressable 
        style={[styles.button]}
