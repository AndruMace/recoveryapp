...
async function generateKey() {
  ...
  let actiKeys = await getActiKeys()
  return `acti_${ranFormatted}_${actiKeys.length}`
}
...
export default function ActivitiesScreen() {
  ...
  return (
    <View style={styles.viewStyle}>
      <Text style={styles.text}>What can I do instead of relapse?</Text>
      <TextInput 
        style={styles.input} 
        onChangeText={setText} 
        value={text}
        placeholder='E.g. "I can go on a walk, I can..."'
        multiline={true}
      />
      <Pressable 
        style={[styles.button]}
